...
![Просмотр сетевых интерфейсов у ws1](images/screenshot_part2_ws1.png)

**Просмотр сетевых интерфейсов у ws2**

![Просмотр сетевых интерфейсов у ws2](images/screenshot_part2_ws2.png)
...
![Содержание netplan на ws1](images/screenshot_part2_netplan_ws1.png)

**Содержание файла `/etc/netplan/00-installer-config.yaml` на ws2 после изменений**

![Содержание netplan на ws2](images/screenshot_part2_netplan_ws2.png)

## Выполнила команду `netplan apply` для перезапуска сервиса сети

**Выполнение команды `netplan apply` на ws1**

![Применение netplan на ws1](images/screenshot_part2_apply_ws1.png)

**Выполнение команды `netplan apply` на ws2**

![Применение netplan на ws2](images/screenshot_part2_apply_ws2.png)
...
![Сервер на ws1](images/screenshot_part3_iperf3_server_ws1.png)

**Запуск клиента на ws2 и измерение скорости до ws1 (192.168.100.10)**

![Клиент ws2 -> ws1](images/screenshot_part3_iperf3_client_ws2_to_ws1.png)

**Запуск сервера iperf3 на ws2**

![Сервер на ws2](images/screenshot_part3_iperf3_server_ws2.png)

**Запуск клиента на ws1 и измерение скорости до ws2 (172.24.116.8)**

![Клиент ws1 -> ws2](images/screenshot_part3_iperf3_client_ws1_to_ws2.png)
...
![Содержимое firewall.sh на ws1](images/screenshot_part4_firewall_ws1.png)

**Содержимое файла `/etc/firewall.sh` на ws2**

![Содержимое firewall.sh на ws2](images/screenshot_part4_firewall_ws2.png)

**Запуск скрипта на ws1**

![Запуск firewall.sh на ws1](images/screenshot_part4_run_ws1.png)

**Запуск скрипта на ws2**

![Запуск firewall.sh на ws2](images/screenshot_part4_run_ws2.png)
...
![Пинг ws2 → ws1](images/screenshot_part4_ping_ws2_to_ws1.png)

**Проверка nmap: хост ws1 запущен, несмотря на блокировку ping**

![Nmap ws1](images/screenshot_part4_nmap_ws2_to_ws1.png)
...
![netplan ws11](images/screenshot_part5_1_netplan_ws11.png)

**Рабочая станция ws21**

![netplan ws21](images/screenshot_part5_1_netplan_ws21.png)

**Рабочая станция ws22**

![netplan ws22](images/screenshot_part5_1_netplan_ws22.png)

**Роутер r1**

![netplan r1](images/screenshot_part5_1_netplan_r1.png)

**Роутер r2**

![netplan r2](images/screenshot_part5_1_netplan_r2.png)

## Перезапуск сети с помощью `sudo netplan apply` и  проверка назначенных IP-адресов `ip -4 a`

**Рабочая станция ws11**

![ip -4 a ws11](images/screenshot_part5_1_ip_ws11.png)

**Рабочая станция ws21**

![ip -4 a ws21](images/screenshot_part5_1_ip_ws21.png)

**Рабочая станция ws22**

![ip -4 a ws22](images/screenshot_part5_1_ip_ws22.png)

**Роутер r1**

![ip -4 a r1](images/screenshot_part5_1_ip_r1.png)

**Роутер r2**

![ip -4 a r2](images/screenshot_part5_1_ip_r2.png)

## Проверка доступности (ping)

**Пинг с ws21 до ws22**

![ping ws21 → ws22](images/screenshot_part5_1_ping_ws21_to_ws22.png)

**Пинг с ws11 до роутера r1**

![ping ws11 → r1](images/screenshot_part5_1_ping_ws11_to_r1.png)

## 5.2 Включение переадресации IP-адресов

**Вызов и вывод команды `sysctl -w net.ipv4.ip_forward=1` на r1**

![sysctl cmd r1](images/screenshot_part5_2_sysctl_cmd_r1.png)

**Вызов и вывод команды `sysctl -w net.ipv4.ip_forward=1` на r2**

![sysctl cmd r2](images/screenshot_part5_2_sysctl_cmd_r2.png)

**Изменённый файл `/etc/sysctl.conf` на r1**

![sysctl conf r1](images/screenshot_part5_2_sysctl_conf_r1.png)

**Изменённый файл `/etc/sysctl.conf` на r2**

![sysctl conf r2](images/screenshot_part5_2_sysctl_conf_r2.png)

## 5.3 Установка маршрута по умолчанию

**Содержание `/etc/netplan/00-installer-config.yaml` на ws11:**

![netplan ws11](images/screenshot_part5_3_netplan_ws11.png)

**Содержание `/etc/netplan/00-installer-config.yaml` на ws21:**

![netplan ws21](images/screenshot_part5_3_netplan_ws21.png)

**Содержание `/etc/netplan/00-installer-config.yaml` на ws22:**

![netplan ws22](images/screenshot_part5_3_netplan_ws22.png)

**Вывод `ip r` на ws11:**

![ip r ws11](images/screenshot_part5_3_ip_r_ws11.png)

**Вывод `ip r` на ws21:**

![ip r ws21](images/screenshot_part5_3_ip_r_ws21.png)

**Вывод `ip r` на ws22:**

![ip r ws22](images/screenshot_part5_3_ip_r_ws22.png)

**Пинг с ws11 до r2:**

![ping ws11 to r2](images/screenshot_part5_3_ping_ws11_to_r2.png)

**Захват пакетов на r2 с помощью команды `tcpdump -tn -i enp0s9`**

![tcpdump r2](images/screenshot_part5_3_tcpdump_r2.png)

## 5.4 Добавление статических маршрутов

**Содержание `/etc/netplan/00-installer-config.yaml` на r1:**

![netplan r1](images/screenshot_part5_4_netplan_r1.png)

**Содержание `/etc/netplan/00-installer-config.yaml` на r2:** 

![netplan r2](images/screenshot_part5_4_netplan_r2.png)

**Вывод `ip r` на r1:**

![ip r r1](images/screenshot_part5_4_ip_r_r1.png)

**Вывод `ip r` на r2:**

![ip r r2](images/screenshot_part5_4_ip_r_r2.png)


**Запросы маршрутов к сети 10.10.0.0/18 и к 0.0.0.0/0 на ws11:**

![ip r list ws11](images/screenshot_part5_4_ip_r_list_ws11.png)
...
![tcpdump r1](images/screenshot_part5_5_tcpdump_r1.png)

**Traceroute с ws11 до ws21:**

![traceroute ws11 to ws21](images/screenshot_part5_5_traceroute_ws11_to_ws21.png)
...
![tcpdump r1](images/screenshot_part5_6_tcpdump_r1.png)


**Выполнение ping с ws11 на 10.30.0.111:**

![ping ws11](images/screenshot_part5_6_ping_ws11.png)
...
![dhcpd r2](images/screenshot_part6_dhcpd_r2.png)

**Содержание `/etc/resolv.conf` на r2:**

![resolv r2](images/screenshot_part6_resolv_r2.png)

**Перезапуск DHCP-сервера на r2:**

![systemctl restart r2](images/screenshot_part6_systemctl_restart_r2.png)

**Перезагрузка ws21:**

![reboot ws21](images/screenshot_part6_reboot_ws21.png)

**Вывод `ip a` на ws21:**

![ip a ws21](images/screenshot_part6_ip_a_ws21.png)

**Пинг с ws21 до ws22:**

![ping ws21 to ws22](images/screenshot_part6_ping_ws21_to_ws22.png)

## Настройка DHCP-сервера на r1

**Содержание `/etc/netplan/00-installer-config.yaml` на ws11:**

![netplan ws11 mac](images/screenshot_part6_netplan_ws11_mac.png)

**Содержание `/etc/dhcp/dhcpd.conf` на r1:**

![dhcpd r1](images/screenshot_part6_dhcpd_r1.png)

**Перезапуск DHCP-сервера на r1:**

![systemctl restart r1](images/screenshot_part6_systemctl_restart_r1.png)

**Вывод `ip a` на ws11:**

![ip a ws11](images/screenshot_part6_ip_a_ws11.png)

## Пример обновления IP-адреса на ws21

**Вывод `ip a` на ws21 до обновления:**

![ip before renew](images/screenshot_part6_ip_before_renew_ws21.png)

**Запрос нового IP-адреса на ws21:**

![dhclient ws21](images/screenshot_part6_dhclient_ws21.png)

**Вывод `ip a` на ws21 после обновления:**

![ip after renew](images/screenshot_part6_ip_after_renew_ws21.png)
...
![ports conf r1](images/screenshot_part7_ports_conf_r1.png)

**Содержание `/etc/apache2/ports.conf` на ws22:**

![ports conf ws22](images/screenshot_part7_ports_conf_ws22.png)

**Запуск Apache на r1:**

![apache start r1](images/screenshot_part7_apache_start_r1.png)

**Запуск Apache на ws22:**

![apache start ws22](images/screenshot_part7_apache_start_ws22.png)
...
![firewall r2 drop](images/screenshot_part7_firewall_r2_drop.png)

**Выдача прав и запуск фаервола на r2:**

![firewall apply r2](images/screenshot_part7_firewall_apply_r2.png)

**Пинг с ws22 до r1 (не должен проходить):**

![ping drop](images/screenshot_part7_ping_ws22_to_r1_drop.png)
...
![firewall r2 icmp](images/screenshot_part7_firewall_r2_icmp.png)

**Пинг с ws22 до r1 (успешный):**

![ping icmp](images/screenshot_part7_ping_ws22_to_r1_icmp.png)
...
![firewall r2 nat](images/screenshot_part7_firewall_r2_nat.png)

**Проверка SNAT:**

![telnet snat](images/screenshot_part7_telnet_ws22_to_r1_snat.png)

**Проверка DNAT:**

![telnet dnat](images/screenshot_part7_telnet_r1_to_ws22_dnat.png)
...
![ports_conf_ws22](images/screenshot_part8_ports_conf_ws22_localhost.png)

**Перезапуск Apache на ws22:**

![apache_restart_ws22](images/screenshot_part8_apache_restart_ws22.png)

**Local TCP forwarding с ws21 до ws22:**

![local_forwarding_ws21](images/screenshot_part8_local_forwarding_ws21.png)

**Проверка подключения с помощью команды `telnet 127.0.0.1` на ws21):**

![telnet_local_ws21](images/screenshot_part8_telnet_local_ws21.png)

**Remote TCP forwarding с ws11 до ws22:**

![remote_forwarding_ws11](images/screenshot_part8_remote_forwarding_ws11.png)

**Проверка подключения с помощью команды `telnet 127.0.0.1` на ws11):**

![telnet_remote_ws11](images/screenshot_part8_telnet_remote_ws11.png)
